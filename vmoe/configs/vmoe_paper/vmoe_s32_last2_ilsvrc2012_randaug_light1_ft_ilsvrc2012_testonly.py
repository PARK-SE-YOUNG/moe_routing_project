...
BATCH_SIZE = 128    # Number of images processed in each step.
...
def get_config():
  ...
  # Minimal train dataset required by train_and_evaluate.
  # This is not used for reporting baseline accuracy.
  config.dataset.train = get_data_eval_config(
      name='imagenet2012', split='validation[:128]',
      process=f'decode|resize({IMAGE_SIZE})|{pp_common}')
  # Main baseline evaluation dataset.
