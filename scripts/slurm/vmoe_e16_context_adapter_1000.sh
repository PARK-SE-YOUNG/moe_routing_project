...
export WANDB_NAME="${WANDB_NAME:-e16-context-adapter-1000steps}"

python -m vmoe.train.main \
  --config=vmoe/configs/vmoe_paper/vmoe_s32_last2_ilsvrc2012_randaug_light1_ft_ilsvrc2012_e16_context_adapter_1000.py \
  --workdir=/workspace/moe_routing_project/logs/e16_context_adapter_1000
